...
// In ffmpeg/doc/APIchanges:
// 2021-03-21 - b671f49630 - lavc 58.134.100 - packet.h
//   Add a new header for AVPacket and related functions.
#if LIBAVCODEC_VERSION_INT >= AV_VERSION_INT(58, 134, 100)
# define SCRCPY_LAVC_HAS_PACKET_H
#endif
...
# define SCRCPY_SDL_HAS_YUV_CONVERSION_MODE
#endif
